"""Tests for squad generation functionality.

Tests for:
- Initial squad optimization via simulated annealing
- Pydantic data contracts and validation
- Constraint handling (budget, formation, must-include/exclude)
- Optimization quality metrics
- Edge cases

Wildcard optimization tests:
- Wildcard chip optimization wrapper
- Budget reset to £100m
- Horizon configuration support
"""

import pytest
import pandas as pd
from fpl_team_picker.domain.services.optimization_service import OptimizationService
from fpl_team_picker.domain.services.optimization.optimization_base import (
...
# ============================================================================
# Initial Squad Optimization Tests
# ============================================================================
...
class TestWildcardBasicFunctionality:
    ...
    def test_wildcard_builds_valid_squad(
        self, optimization_service, current_squad, team_data, wildcard_players
    ):
        ...
        squad_df, result_summary, metadata = (
            optimization_service.optimize_wildcard_squad(
                ...
                team_data=team_data,
                players_with_xp=wildcard_players,
            )
        )
