...
@app.cell
def __(pd, players_with_xp, create_player_trends_visualization):
...
@app.cell
def __(mo, player_selector, attribute_selector, multi_player_selector, trends_data, create_trends_chart):
    # Initialize once
    trends_chart = None
...
@app.cell
def __(gameweek_input, mo, create_fixture_difficulty_visualization):
...
def main():
    """Entry point for fpl-gameweek-manager command."""
    app.run()
